...
with open('true_or_false_with_description_internvl3.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
with open('true_or_false_with_description_internvl3_test.json', 'w', encoding='utf-8') as f:
