...
with open('true_or_false_with_description_llava_ov_7b.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
with open('true_or_false_with_description_llava_ov_7b_test.json', 'w', encoding='utf-8') as f:
