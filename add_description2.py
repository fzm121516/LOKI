...
with open('true_or_false_with_description_minicpm.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
with open('true_or_false_with_description_minicpm2.json', 'w', encoding='utf-8') as f:
