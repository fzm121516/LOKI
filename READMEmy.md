...
CUDA_VISIBLE_DEVICES=0 python run.py --model_config_path configs/models/saa_qwen2.config.yaml --task_config_path configs/tasks/video/video_tf_loki.yaml --batch_size 1 
